...
public enum DMessage implements Message {
    ...
    FEE_REQUIREMENT("Fee_Requirement", "&6You need &4v1 &6to continue."),
    FORBIDDEN_ITEM_REQUIREMENT("Forbidden_Item_Requirement", "&6You cannot have the follow items to continue: &4v1"),
    GROUP_SIZE_REQUIREMENT("Group_Size_Requirement", "&6Your group v1 players, v2"),
    KEY_ITEM_REQUIREMENT("Key_Item_Requirement", "&6You are missing the following key items: &4v1"),
    PERMISSION_REQUIREMENT("Key_Item_Requirement", "&6You are missing the following permissions: &4v1"),
    REQUIRE_FINISHED_ONCE("Require_Dungeon_Finish_Once", "&6You must have finished one of these dungeons once: &4v1"),
    REQUIRE_FINISHED_ALL("Require_Dungeon_Finish_All", "&6You must have completed all of these dungeons beforehand: &4v1"),
    REQUIRE_WAIT_BETWEEN("Require_Dungeon_Wait_Between", "&6You must wait &4v1&6 before attempting this dungeon."),
